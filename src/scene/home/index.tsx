...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="home" className="gap-16 bg-gray-20 py-10 md:h-full md:pb-0">
        ...
        <motion.div className="mx-auto w-5/6 items-center justify-center md:mt-8 md:flex md:h-5/6 md:mb-10"
            onViewportEnter={() => setSelectedPage(SelectedPage.Home)}
        >
            {/* MAIN HEADER */}
            <div className="z-10 mt-14 md:mt-36 md:basis-3/5">
                {/* HEADINGS */}
        ...
        {isAboveMediumScreens && (
            <div className="h-[150px] w-full bg-primary-100 py-10 xl:mt-3">
